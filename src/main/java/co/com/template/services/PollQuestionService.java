...
public class PollQuestionService {
    ...
    public ResponseDTO createQuestionOfPoll(CreatePollQuestionDTO request){
        try{
            ...
            PollType type = pollTypeRepository.findByPollTypeId(request.getPollTypeId()==null?Constants.FOLLOW_POLL_ID : request.getPollTypeId());
            ...
            if(Objects.nonNull(request.getPollTypeId()) && !request.getPollTypeId().equals(Constants.FOLLOW_POLL_ID)) {
    ...
    public ResponseDTO getQuestionsOfPoll(Long pollTypeId){
        try{
            ...
            Long type = pollTypeId == null ? Constants.FOLLOW_POLL_ID : pollTypeId;
